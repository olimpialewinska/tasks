            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('home') }}">Twoje zadania</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                        @if($task->requser == Auth::user()->id)
                                        <a class="btn btn-outline-primary me-md-2" type="button" href="/edit/{{$task->id}}">Edytuj</a>
                                        @endif
                                        <a class="btn btn-outline-success me-md-2" type="button" href="/done/{{$task->id}}">Wykonano</a>
                                        <a class="btn btn-outline-danger" type="button" href="/delete/{{$task->id}}">Odrzuć</a>
                                    </div>
                                </div>
                            </div>
                        </div>
