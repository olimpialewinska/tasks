...
<div class="container">
    <div class="row justify-content-center">
    <div class="card-body">
                    <h3 style="padding:20px">Edytowanie zadania dla: {{$task->exename}}</h3>
                    <div class="row justify-content-center">
                        <div class="col-md-7">
                            <form action="/updateassigned/{{$task->id}}" method="post">
                            @csrf
                                ...
                                <a class="btn btn-outline-primary me-md-2" style="width:100px"type="button" href="{{route('assignedtask')}}">Anuluj</a>
